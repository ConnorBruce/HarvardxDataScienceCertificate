...
* The **"pwd"** command will display your working directory. The "/" symbol separates directories, while the first "/" at the beginning of the path stands for the root directory. WHen a path starts with "/", it is a "full path", which finds the currect directory from the root directory.
